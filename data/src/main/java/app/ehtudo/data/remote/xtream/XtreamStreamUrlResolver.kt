...
import app.ehtudo.data.remote.jellyfin.buildJellyfinAuthorizationHeader
...
import app.ehtudo.data.remote.stalker.StalkerPlaybackResolutionException
...
import app.ehtudo.data.remote.stalker.buildStalkerPlaybackDescriptor
...
class XtreamStreamUrlResolver @Inject constructor(
        ...
        return when (resolvedProvider.type) {
            ...
            ProviderType.STALKER_PORTAL -> {
                ...
                val playbackInfo = when (
                    ...
                    is app.ehtudo.domain.model.Result.Success -> resolvedResult.data
                    is app.ehtudo.domain.model.Result.Error -> throw StalkerPlaybackResolutionException(
    ...
    private suspend fun resolveDirectStalkerUrl(
        ...
        val descriptor = buildStalkerPlaybackDescriptor(
            ...
            capabilities = app.ehtudo.data.remote.stalker.StalkerPortalCapabilities()
        )
    ...
    private suspend fun persistStalkerPlaybackLearning(
        provider: ProviderEntity,
        playbackInfo: app.ehtudo.data.remote.stalker.StalkerPlaybackInfo
    ) {
