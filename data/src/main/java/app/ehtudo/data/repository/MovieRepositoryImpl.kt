...
import app.ehtudo.data.local.entity.MovieBrowseEntity
...
import app.ehtudo.data.sync.ContentCachePolicy
import app.ehtudo.data.sync.SyncManager
import app.ehtudo.data.util.MoviePresentationSettings
import app.ehtudo.data.util.buildPresentedMovies
import app.ehtudo.data.util.rankSearchResults
import app.ehtudo.data.util.toFtsPrefixQuery
...
import app.ehtudo.domain.model.MovieDetailPresentationHint
import app.ehtudo.domain.model.Movie
import app.ehtudo.domain.model.PagedResult
...
import app.ehtudo.domain.model.Result.Success
...
import app.ehtudo.domain.model.VodMovieVariant
...
class MovieRepositoryImpl @Inject constructor(
    ...
    private suspend fun loadPresentationCandidates(movie: Movie): List<app.ehtudo.data.local.entity.MovieEntity> {
    ...
    private fun app.ehtudo.data.local.entity.MovieEntity.hasFreshXtreamDetails(now: Long = System.currentTimeMillis()): Boolean {
