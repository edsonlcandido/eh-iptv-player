package app.ehtudo.data.mapper

import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import app.ehtudo.data.local.entity.*
import app.ehtudo.data.remote.stalker.StalkerPlaybackDescriptor
import app.ehtudo.data.remote.stalker.StalkerUrlFactory
import app.ehtudo.data.remote.xtream.XtreamStreamKind
import app.ehtudo.data.remote.xtream.XtreamUrlFactory
import app.ehtudo.domain.model.*
...
fun CategoryEntity.toDomain() = app.ehtudo.domain.model.Category(
    id = categoryId,
    roomId = id,
    name = name,
    parentId = parentId,
...
fun app.ehtudo.domain.model.Category.toEntity(providerId: Long) = CategoryEntity(
    categoryId = id,
    name = name,
    parentId = parentId,
    type = type,
...
fun SyncMetadataEntity.toDomain() = SyncMetadata(
    ...
    movieSyncMode = runCatching { app.ehtudo.domain.model.VodSyncMode.valueOf(movieSyncMode) }
        .getOrDefault(app.ehtudo.domain.model.VodSyncMode.UNKNOWN),
...
fun EpgSourceEntity.toDomain() = app.ehtudo.domain.model.EpgSource(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun app.ehtudo.domain.model.EpgSource.toEntity() = EpgSourceEntity(
    id = id,
    name = name,
    url = url,
    enabled = enabled,
...
fun app.ehtudo.data.local.dao.ProviderEpgSourceWithDetails.toDomain() =
    app.ehtudo.domain.model.ProviderEpgSourceAssignment(
        id = id,
        providerId = providerId,
...
fun app.ehtudo.domain.model.ProviderEpgSourceAssignment.toEntity() = ProviderEpgSourceEntity(
    id = id,
    providerId = providerId,
    epgSourceId = epgSourceId,
    priority = priority,
...
fun EpgChannelEntity.toDomain() = app.ehtudo.domain.model.EpgChannelInfo(
    id = id,
    epgSourceId = epgSourceId,
...
fun ChannelEpgMappingEntity.toDomain() = app.ehtudo.domain.model.ChannelEpgMapping(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
    sourceType = runCatching { app.ehtudo.domain.model.EpgSourceType.valueOf(sourceType) }
        .getOrDefault(app.ehtudo.domain.model.EpgSourceType.NONE),
    epgSourceId = epgSourceId,
    xmltvChannelId = xmltvChannelId,
    matchType = matchType?.let {
        runCatching { app.ehtudo.domain.model.EpgMatchType.valueOf(it) }.getOrNull()
    },
...
fun app.ehtudo.domain.model.ChannelEpgMapping.toEntity() = ChannelEpgMappingEntity(
    id = id,
    providerChannelId = providerChannelId,
    providerId = providerId,
