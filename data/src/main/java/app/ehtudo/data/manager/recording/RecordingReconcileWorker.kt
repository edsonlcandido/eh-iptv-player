...
class RecordingReconcileWorker(
    ...
    interface RecordingWorkerEntryPoint {
        fun recordingManager(): app.ehtudo.domain.manager.RecordingManager
    }
    ...
    override suspend fun doWork(): Result {
        ...
        return when (manager.reconcileRecordingState()) {
            is app.ehtudo.domain.model.Result.Success -> Result.success()
            is app.ehtudo.domain.model.Result.Error -> Result.retry()
            app.ehtudo.domain.model.Result.Loading -> Result.retry()
        }
    }
