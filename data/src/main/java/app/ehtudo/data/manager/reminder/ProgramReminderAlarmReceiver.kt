package app.ehtudo.data.manager.reminder

import android.content.BroadcastReceiver
import android.content.Context
import android.content.Intent
import app.ehtudo.data.manager.ProgramReminderManagerImpl
...
class ProgramReminderAlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_NOTIFY_REMINDER = "app.ehtudo.data.reminder.action.NOTIFY"
