...
class OkHttpStalkerApiServiceTest {
    ...
    fun authenticate_module_gated_recipe_rebuilds_profile_for_modern_mag_preset() = runTest {
        ...
        val result = service.authenticate(
            buildStalkerDeviceProfile(
                ...
                portalFingerprintHint = app.ehtudo.domain.model.StalkerPortalFingerprint.MODULE_GATED,
                deviceProfile = "MAG250",
                timezone = "UTC",
                locale = "en"
            )
    ...
    fun buildStalkerDeviceProfile_sanitizes_impossible_auth_mode_hints() {
        val credentialsOnly = buildStalkerDeviceProfile(
            portalUrl = "https://portal.example.com/c",
            macAddress = "",
            authMode = app.ehtudo.domain.model.StalkerAuthMode.MAC_PLUS_CREDENTIALS,
            username = "alice",
            password = "secret",
            deviceProfile = "MAG250",
            timezone = "UTC",
        ...
        val macOnly = buildStalkerDeviceProfile(
            portalUrl = "https://portal.example.com/c",
            macAddress = "00:1A:79:12:34:56",
            authMode = app.ehtudo.domain.model.StalkerAuthMode.CREDENTIALS_ONLY,
            username = "",
            password = "",
            deviceProfile = "MAG250",
            timezone = "UTC",
        ...
        val strictProfile = buildStalkerDeviceProfile(
            portalUrl = "https://portal.example.com/c",
            macAddress = "00:1A:79:12:34:56",
            authMode = app.ehtudo.domain.model.StalkerAuthMode.MAC_ONLY,
            magPresetHint = app.ehtudo.domain.model.StalkerMagPreset.MAG254_STRICT,
            username = "",
            password = "",
            deviceProfile = "MAG250",
            timezone = "UTC",
        ...
        assertThat(credentialsOnly.authMode).isEqualTo(app.ehtudo.domain.model.StalkerAuthMode.CREDENTIALS_ONLY)
        assertThat(macOnly.authMode).isEqualTo(app.ehtudo.domain.model.StalkerAuthMode.MAC_ONLY)
