...
import app.ehtudo.iptv.diagnostics.RuntimeDiagnosticsManager
import app.ehtudo.iptv.update.GitHubReleaseChecker
import app.ehtudo.iptv.ui.accessibility.isReducedMotionEnabled
import app.ehtudo.data.remote.jellyfin.JellyfinImageAuthInterceptor
...
import app.ehtudo.data.manager.recording.RecordingReconcileWorker
import app.ehtudo.data.sync.ProviderSyncWorker
import app.ehtudo.data.sync.XtreamIndexWorker
import app.ehtudo.player.timeshift.TimeshiftDiskManager
...
class StreamVaultApp : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        val gcWorkRequest = PeriodicWorkRequestBuilder<app.ehtudo.data.sync.SyncWorker>(24, java.util.concurrent.TimeUnit.HOURS)
