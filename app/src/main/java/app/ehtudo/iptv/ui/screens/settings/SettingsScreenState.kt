...
import app.ehtudo.iptv.util.OfficialBuildStatus
...
private fun formatExternalPlaybackModeLabel(
    mode: app.ehtudo.domain.model.ExternalPlaybackMode,
    context: Context
): String = when (mode) {
    app.ehtudo.domain.model.ExternalPlaybackMode.INTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_internal)
    app.ehtudo.domain.model.ExternalPlaybackMode.ASK_EVERY_TIME -> context.getString(R.string.settings_external_playback_mode_external)
    app.ehtudo.domain.model.ExternalPlaybackMode.EXTERNAL_PLAYER -> context.getString(R.string.settings_external_playback_mode_external)
}
