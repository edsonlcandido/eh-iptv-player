package app.ehtudo.iptv.ui.screens.series
...
import app.ehtudo.iptv.ui.components.SearchInput
import androidx.compose.ui.platform.LocalFocusManager
import androidx.compose.ui.platform.LocalConfiguration
import androidx.compose.ui.platform.LocalSoftwareKeyboardController
import app.ehtudo.iptv.device.rememberIsTelevisionDevice
import app.ehtudo.iptv.navigation.Routes
import app.ehtudo.iptv.ui.components.CategoryRow
import app.ehtudo.iptv.ui.components.ContinueWatchingRow
import app.ehtudo.iptv.ui.components.SavedCategoryContextCard
import app.ehtudo.iptv.ui.components.SavedCategoryShortcut
import app.ehtudo.iptv.ui.components.SavedCategoryShortcutsRow
import app.ehtudo.iptv.ui.components.SelectionChip
import app.ehtudo.iptv.ui.components.SelectionChipRow
import app.ehtudo.iptv.ui.components.SeriesCard
import app.ehtudo.iptv.ui.theme.*
import app.ehtudo.domain.model.Category
import app.ehtudo.domain.model.LibraryFilterType
import app.ehtudo.domain.model.LibrarySortBy
...
import app.ehtudo.iptv.ui.components.ReorderTopBar
import app.ehtudo.iptv.ui.components.dialogs.DeleteGroupDialog
import app.ehtudo.iptv.ui.components.dialogs.RenameGroupDialog
import app.ehtudo.iptv.ui.components.shell.BrowseHeroPanel
import app.ehtudo.iptv.ui.components.shell.BrowseSearchLaunchCard
import app.ehtudo.iptv.ui.components.shell.LoadMoreCard
import app.ehtudo.iptv.ui.components.shell.InfiniteScrollEffect
import app.ehtudo.iptv.ui.components.shell.AppNavigationChrome
import app.ehtudo.iptv.ui.components.shell.AppMessageState
import app.ehtudo.iptv.ui.components.shell.AppScreenScaffold
import app.ehtudo.iptv.ui.components.shell.VodActionChip
import app.ehtudo.iptv.ui.components.shell.VodActionChipRow
import app.ehtudo.iptv.ui.components.shell.VodCategoryOption
import app.ehtudo.iptv.ui.components.shell.VodCategoryPickerDialog
import app.ehtudo.iptv.ui.components.shell.VodBrowseOptionsDialog
...
import app.ehtudo.iptv.ui.screens.vod.HandleVodUserMessage
import app.ehtudo.iptv.ui.screens.vod.ProtectedVodPinDialog
import app.ehtudo.iptv.ui.screens.vod.VodBrowseDefaults
import app.ehtudo.iptv.ui.screens.vod.vodActiveFilterSortDetail
...
fun SeriesScreen(
    ...
    // Foco inicial: só tentamos mover o foco do item "Séries" da TopBar para
    ...
    val hasFavorites = uiState.seriesByCategory[uiState.favoriteCategoryName]?.isNotEmpty() == true
    val hasContinueSeries = uiState.libraryLensRows[SeriesLibraryLens.CONTINUE]?.isNotEmpty() == true
    val hasFresh = uiState.libraryLensRows[SeriesLibraryLens.FRESH]?.isNotEmpty() == true
    val hasTopRated = uiState.libraryLensRows[SeriesLibraryLens.TOP_RATED]?.isNotEmpty() == true
    val hasCategoryItems = uiState.seriesByCategory.any { (_, items) -> items.isNotEmpty() }
    val hasGridItems = uiState.selectedCategory != null && uiState.selectedCategoryItems.isNotEmpty()
    val hasAnyTarget = hasContinueWatching || hasFavorites || hasContinueSeries ||
        hasFresh || hasTopRated || hasCategoryItems || hasGridItems
    ...
    if (uiState.showDialog && uiState.selectedSeriesForDialog != null) {
        ...
        app.ehtudo.iptv.ui.components.dialogs.AddToGroupDialog(
    ...
    if (uiState.selectedCategoryForOptions != null) {
        ...
        app.ehtudo.iptv.ui.components.dialogs.CategoryOptionsDialog(
            category = category,
