...
internal fun observeSettingsPreferenceSnapshot(
    ...
    return combine(
        ...
        SettingsPreferenceSnapshot(
            ...
            playerSurfaceMode = app.ehtudo.domain.model.PlayerSurfaceMode.AUTO,
            ...
            remoteShortcutPreferences = app.ehtudo.domain.model.RemoteShortcutPreferences(),
            liveTvCategoryFilters = emptyList(),
            liveTvQuickFilterVisibilityMode = LiveTvQuickFilterVisibilityMode.HIDE,
