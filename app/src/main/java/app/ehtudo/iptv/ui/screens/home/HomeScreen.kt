package app.ehtudo.iptv.ui.screens.home
...
import app.ehtudo.iptv.ui.components.LiveSourceSwitcher
import app.ehtudo.iptv.ui.components.shell.ContentMetadataStrip
import app.ehtudo.iptv.ui.components.shell.LiveChannelRowSurface
import app.ehtudo.iptv.ui.components.shell.StatusPill
import app.ehtudo.iptv.ui.components.TvEmptyState
import app.ehtudo.iptv.ui.components.dialogs.CategoryOptionsDialog
import app.ehtudo.iptv.ui.components.dialogs.HiddenCategoriesDialog
import app.ehtudo.iptv.ui.components.dialogs.HiddenChannelsDialog
import app.ehtudo.iptv.ui.components.dialogs.PinDialog
import app.ehtudo.iptv.ui.components.dialogs.PremiumDialog
import app.ehtudo.iptv.ui.components.dialogs.PremiumDialogActionButton
import app.ehtudo.iptv.ui.components.dialogs.PremiumDialogFooterButton
...
import app.ehtudo.iptv.ui.remote.LiveBrowseRemoteShortcutHandler
import app.ehtudo.iptv.ui.remote.dispatchLiveBrowseRemoteShortcut
import app.ehtudo.iptv.ui.remote.remoteColorButtonForKeyCode
                            ...
                            val handler = when (val target = focusedRemoteShortcutTarget) {
                                ...
                                is FocusedRemoteShortcutTarget.CategoryTarget -> {
                                    ...
                                    if (isLockedCategory && action in setOf(
                                            app.ehtudo.domain.model.RemoteShortcutAction.PIN_CATEGORY,
                                            app.ehtudo.domain.model.RemoteShortcutAction.HIDE_CATEGORY
                                        )
                                    ) {
                                        null
                                    } else {
