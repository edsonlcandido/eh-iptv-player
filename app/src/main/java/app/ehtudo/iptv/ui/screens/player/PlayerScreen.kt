...
import app.ehtudo.player.PLAYER_TRACK_AUTO_ID
import app.ehtudo.player.PlayerEngine
import app.ehtudo.player.PlayerError
import app.ehtudo.player.PlayerRenderSurfaceType
import app.ehtudo.player.PlayerSurfaceResizeMode
import app.ehtudo.player.PlayerTrack
import app.ehtudo.player.TrackType
...
import app.ehtudo.iptv.ui.components.dialogs.ProgramHistoryDialog
import androidx.compose.ui.res.stringResource
import androidx.lifecycle.Lifecycle
import app.ehtudo.iptv.R
import app.ehtudo.iptv.MainActivity
import app.ehtudo.iptv.cast.CastConnectionState
import app.ehtudo.iptv.ui.components.PlayerRenderView
import app.ehtudo.iptv.ui.design.requestFocusSafely
import app.ehtudo.iptv.ui.notifications.rememberNotificationPermissionGate
import app.ehtudo.iptv.ui.screens.player.overlay.ChannelInfoOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.ChannelVariantSelectionDialog
import app.ehtudo.iptv.ui.screens.player.overlay.CategoryListOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.ChannelListOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.DiagnosticsOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.EpgOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerErrorOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerNoticeBanner
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerEpisodeSelectionDialog
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerResumePrompt
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerTrackSelectionDialog
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerAspectRatioToast
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerControlsOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerNumericInputOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerResolutionBadge
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerAudioVideoOffsetDialog
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerSpeedSelectionDialog
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerSleepTimerDialog
import app.ehtudo.iptv.ui.screens.player.overlay.PlayerSleepTimerWarningOverlay
import app.ehtudo.iptv.ui.screens.player.overlay.NextEpisodeCountdownOverlay
import app.ehtudo.iptv.ui.screens.multiview.MultiViewViewModel
import app.ehtudo.iptv.ui.screens.multiview.MultiViewPlannerDialog
...
fun PlayerScreen(
    ...
    Box(
        ...
        if (currentChannelRecording?.status == app.ehtudo.domain.model.RecordingStatus.RECORDING) {
...
private fun PlayerControlsOverlayHost(
    ...
    currentRecordingStatus: app.ehtudo.domain.model.RecordingStatus?,
    isMuted: Boolean,
    playbackSpeed: Float,
    mediaTitle: String?,
    sleepTimerUiState: SleepTimerUiState,
