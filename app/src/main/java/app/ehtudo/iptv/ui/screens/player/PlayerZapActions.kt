...
internal fun PlayerViewModel.changeChannel(index: Int, isAutoFallback: Boolean = false) {
    ...
    viewModelScope.launch {
        ...
        playerEngine.playbackState
            .filter {
                it == app.ehtudo.player.PlaybackState.READY ||
...
internal fun PlayerViewModel.recordLivePlayback(channel: app.ehtudo.domain.model.Channel) {
...
internal fun PlayerViewModel.resolveChannelByNumber(number: Int?): app.ehtudo.domain.model.Channel? {
    if (number == null) return null
    return channelNumberIndex[number]
}

internal fun PlayerViewModel.resolveChannelByPrefix(prefix: String): app.ehtudo.domain.model.Channel? {
...
internal fun PlayerViewModel.resolveChannelNumber(
    channel: app.ehtudo.domain.model.Channel,
    index: Int
