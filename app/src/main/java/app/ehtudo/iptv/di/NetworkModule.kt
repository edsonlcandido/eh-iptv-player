...
import app.ehtudo.data.remote.http.DefaultUserAgentInterceptor
import app.ehtudo.data.remote.http.buildAppRequestProfile
import app.ehtudo.data.remote.http.buildAppUserAgent
import app.ehtudo.data.remote.stalker.OkHttpStalkerApiService
...
import app.ehtudo.player.PlaybackSupportSnapshotStore
...
object NetworkModule {
    ...
    fun provideMainPlayerEngine(
        ...
        playbackCompatibilityRepository: app.ehtudo.domain.repository.PlaybackCompatibilityRepository,
