package app.ehtudo.iptv.plugins

object StreamVaultPluginContract {
    const val API_VERSION = 1

    const val ACTION_PLUGIN_SERVICE = "app.ehtudo.plugin.API"
    const val META_MANIFEST_JSON = "app.ehtudo.plugin.MANIFEST_JSON"
    const val META_ID = "app.ehtudo.plugin.ID"
    const val META_NAME = "app.ehtudo.plugin.NAME"
    const val META_VERSION_NAME = "app.ehtudo.plugin.VERSION_NAME"
    const val META_VERSION_CODE = "app.ehtudo.plugin.VERSION_CODE"
    const val META_DESCRIPTION = "app.ehtudo.plugin.DESCRIPTION"
    const val META_CAPABILITIES = "app.ehtudo.plugin.CAPABILITIES"
    const val META_CONFIGURATION_MODE = "app.ehtudo.plugin.CONFIGURATION_MODE"
    const val META_CONFIGURATION_ACTIVITY_ACTION = "app.ehtudo.plugin.CONFIGURATION_ACTIVITY_ACTION"
    const val META_PROVIDER_NAME = "app.ehtudo.plugin.PROVIDER_NAME"
