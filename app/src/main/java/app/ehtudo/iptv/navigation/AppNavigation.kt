package app.ehtudo.iptv.navigation
...
import app.ehtudo.iptv.ui.screens.dashboard.DashboardScreen
import app.ehtudo.iptv.ui.screens.multiview.MultiViewScreen
import app.ehtudo.iptv.ui.screens.home.HomeScreen
import app.ehtudo.iptv.ui.screens.movies.MoviesScreen
import app.ehtudo.iptv.ui.screens.player.PlayerScreen
import app.ehtudo.iptv.ui.screens.plugins.PluginsScreen
import app.ehtudo.iptv.ui.screens.provider.ProviderSetupScreen
import app.ehtudo.iptv.ui.screens.series.SeriesScreen
import app.ehtudo.iptv.ui.screens.settings.SettingsScreen
import app.ehtudo.iptv.ui.screens.welcome.WelcomeScreen
import app.ehtudo.iptv.ui.screens.downloads.DownloadsScreen
            ...
            DashboardScreen(
                ...
                onRecentChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = app.ehtudo.domain.model.VirtualCategoryIds.RECENT,
                ...
                onFavoriteChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = app.ehtudo.domain.model.VirtualCategoryIds.FAVORITES,
                            providerId = channel.providerId,
                            isVirtual = true,
                            combinedProfileId = combinedProfileId,
                            returnRoute = Routes.HOME
                ...
                onPlaybackHistoryClick = { history ->
                    val route = when (history.contentType) {
                        app.ehtudo.domain.model.ContentType.LIVE -> {
                            Routes.player(
                        ...
                        app.ehtudo.domain.model.ContentType.MOVIE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
                        ...
                        app.ehtudo.domain.model.ContentType.SERIES -> {
                            Routes.seriesDetail(history.contentId, Routes.HOME)
                        }
                        app.ehtudo.domain.model.ContentType.SERIES_EPISODE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
...
// ... (rest of file)
        ...
        composable(
            ...
            app.ehtudo.iptv.ui.screens.epg.FullEpgScreen(
        ...
        composable(
            ...
            app.ehtudo.iptv.ui.screens.settings.parental.ParentalControlGroupScreen(
                currentRoute = Routes.SETTINGS,
                onNavigate = { route -> tabNavigate(route) },
                onBack = { navController.popBackStack() }
            )
        ...
        composable(
            ...
            app.ehtudo.iptv.ui.screens.search.SearchScreen(
        ...
        composable(
            ...
            app.ehtudo.iptv.ui.screens.movies.MovieDetailScreen(
                onPlay = { movie ->
                    navController.navigateToPlayer(
        ...
        composable(
            ...
            app.ehtudo.iptv.ui.screens.series.SeriesDetailScreen(
