...
data class BackupData(
    ...
    val favorites: List<app.ehtudo.domain.model.Favorite>? = null,
    val virtualGroups: List<app.ehtudo.domain.model.VirtualGroup>? = null,
...
interface BackupManager {
     ...
     */
    suspend fun exportConfig(uriString: String): app.ehtudo.domain.model.Result<Unit>
